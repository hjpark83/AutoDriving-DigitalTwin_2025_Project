...
"""autogenerated by genpy from dcas_msgs/ObjectArray.msg. Do not edit."""
import codecs
import sys
...
class ObjectArray(genpy.Message):
  _md5sum = "1a148595d8713c4b90d42f0a686db8d9"
  _type = "dcas_msgs/ObjectArray"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','dcas_msgs/Object[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.objects:
        ...
        length = len(val1.footprint)
        buff.write(_struct_I.pack(length))
        for val2 in val1.footprint:
          _x = val2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (val1.geom_type,) = _get_struct_B().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.footprint = []
