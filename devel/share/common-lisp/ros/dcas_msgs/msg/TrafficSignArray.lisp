...
(cl:defclass <TrafficSignArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (signs
    :reader signs
    :initarg :signs
    :type (cl:vector dcas_msgs-msg:TrafficSign)
   :initform (cl:make-array 0 :element-type 'dcas_msgs-msg:TrafficSign :initial-element (cl:make-instance 'dcas_msgs-msg:TrafficSign))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrafficSignArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficSignArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dcas_msgs-msg:<TrafficSignArray> is deprecated: use dcas_msgs-msg:TrafficSignArray instead.")))
...
(cl:defmethod signs-val ((m <TrafficSignArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcas_msgs-msg:signs-val is deprecated.  Use dcas_msgs-msg:signs instead.")
  (signs m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrafficSignArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'signs)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'dcas_msgs-msg:TrafficSign))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrafficSignArray>)))
  ...
  "06d9b79e9aad276f858f3ff080587c81")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrafficSignArray)))
  "Returns md5sum for a message object of type 'TrafficSignArray"
  "06d9b79e9aad276f858f3ff080587c81")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrafficSignArray>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%dcas_msgs/TrafficSign[] signs~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: dcas_msgs/TrafficSign~%std_msgs/Header header~%uint32 id~%geometry_msgs/Pose pose~%uint8 sign_class~%~%# Traffic sign classes~%uint8 CLASS_UNKNOWN=0~%uint8 CLASS_STOP=1~%uint8 CLASS_YIELD=2~%uint8 CLASS_SPEED_LIMIT_30=3~%uint8 CLASS_SPEED_LIMIT_50=4~%uint8 CLASS_SPEED_LIMIT_60=5~%uint8 CLASS_SPEED_LIMIT_80=6~%uint8 CLASS_NO_ENTRY=7~%uint8 CLASS_NO_PARKING=8~%uint8 CLASS_PEDESTRIAN_CROSSING=9~%uint8 CLASS_SCHOOL_ZONE=10~%uint8 CLASS_CONSTRUCTION=11~%uint8 CLASS_TURN_LEFT=12~%uint8 CLASS_TURN_RIGHT=13~%uint8 CLASS_GO_STRAIGHT=14~%~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrafficSignArray)))
  "Returns full string definition for message of type 'TrafficSignArray"
  (cl:format cl:nil "std_msgs/Header header~%dcas_msgs/TrafficSign[] signs~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: dcas_msgs/TrafficSign~%std_msgs/Header header~%uint32 id~%geometry_msgs/Pose pose~%uint8 sign_class~%~%# Traffic sign classes~%uint8 CLASS_UNKNOWN=0~%uint8 CLASS_STOP=1~%uint8 CLASS_YIELD=2~%uint8 CLASS_SPEED_LIMIT_30=3~%uint8 CLASS_SPEED_LIMIT_50=4~%uint8 CLASS_SPEED_LIMIT_60=5~%uint8 CLASS_SPEED_LIMIT_80=6~%uint8 CLASS_NO_ENTRY=7~%uint8 CLASS_NO_PARKING=8~%uint8 CLASS_PEDESTRIAN_CROSSING=9~%uint8 CLASS_SCHOOL_ZONE=10~%uint8 CLASS_CONSTRUCTION=11~%uint8 CLASS_TURN_LEFT=12~%uint8 CLASS_TURN_RIGHT=13~%uint8 CLASS_GO_STRAIGHT=14~%~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
