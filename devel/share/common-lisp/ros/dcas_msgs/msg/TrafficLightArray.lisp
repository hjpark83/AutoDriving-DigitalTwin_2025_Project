...
(cl:defclass <TrafficLightArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (lights
    :reader lights
    :initarg :lights
    :type (cl:vector dcas_msgs-msg:TrafficLight)
   :initform (cl:make-array 0 :element-type 'dcas_msgs-msg:TrafficLight :initial-element (cl:make-instance 'dcas_msgs-msg:TrafficLight))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLightArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLightArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dcas_msgs-msg:<TrafficLightArray> is deprecated: use dcas_msgs-msg:TrafficLightArray instead.")))
...
(cl:defmethod lights-val ((m <TrafficLightArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcas_msgs-msg:lights-val is deprecated.  Use dcas_msgs-msg:lights instead.")
  (lights m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrafficLightArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lights)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'dcas_msgs-msg:TrafficLight))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrafficLightArray>)))
  ...
  "ae3faa55d431d7df7116cd9eb141ea12")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrafficLightArray)))
  "Returns md5sum for a message object of type 'TrafficLightArray"
  "ae3faa55d431d7df7116cd9eb141ea12")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrafficLightArray>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%dcas_msgs/TrafficLight[] lights~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: dcas_msgs/TrafficLight~%std_msgs/Header header~%geometry_msgs/Pose pose~%uint8 state~%~%uint8 RED=0~%uint8 YELLOW=1~%uint8 GREEN=2~%~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrafficLightArray)))
  "Returns full string definition for message of type 'TrafficLightArray"
  (cl:format cl:nil "std_msgs/Header header~%dcas_msgs/TrafficLight[] lights~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: dcas_msgs/TrafficLight~%std_msgs/Header header~%geometry_msgs/Pose pose~%uint8 state~%~%uint8 RED=0~%uint8 YELLOW=1~%uint8 GREEN=2~%~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
